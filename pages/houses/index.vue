<template>
  <div class="container">
    <!--    {{ houses }}-->
    <div v-for="houses in houses" :key="houses['id']" class="col-xs-12 col-md-6 bootstrap snippets bootdeys" @click="">
      <v-card>
...
export default {
  ...
  async asyncData ({ $axios, params }) {
    ...
    // console.info($axios.$get('http://localhost:8000/api/list'))
    // console.info(123123123)
