  ...
  <div>
    ...
    <form @submit.prevent="handleSubmit">
      <div class="form-group">
        ...
        <input type="text" v-model="name" v-validate="'required'" name="name" class="form-control" :class="{ 'is-invalid': submitted && errors.has('firstName') }" />
      ...
      <div class="form-group">
        <button @click="postRegister" class="btn btn-primary" :disabled="registering">Register</button>
